...
namespace tracker
{
    public partial class rptTotalCost : Form
    {
        ...
        private void rptTotalCost_Load(object sender, EventArgs e)
        {
        ...
        {
            string query = "select * from [Total Maint Cost by Vehicle]";
        ...
        private void rptTotalCost_Load_1(object sender, EventArgs e)
        {
